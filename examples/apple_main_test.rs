//! Test whether on_main() works with #[apple_main::main]
//!
//! Run with: cargo run --example apple_main_test
//!
//! This should work because #[apple_main::main] runs CFRunLoop on main thread.

use std::time::Duration;

#[apple_main::main]
async fn main() {
    println!("Testing on_main() with #[apple_main::main]...");
    ...
    println!("on_main() works with #[apple_main::main].");
    println!("========================================");
